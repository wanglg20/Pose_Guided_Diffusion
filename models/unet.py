"""
original Unet with pretrained weight
directly copied from https://github.com/openai/guided-diffusion
"""
        ...
        for level, mult in enumerate(channel_mult):
            for _ in range(num_res_blocks):
                ...
                if ds in attention_resolutions:
                    ...
                    self.down_attn_level.append(self.input_blocks.__len__())
        ...
        for level, mult in list(enumerate(channel_mult))[::-1]:
            for i in range(num_res_blocks + 1):
                ...
                if ds in attention_resolutions:
                    ...
                    self.up_attn_level.append(self.output_blocks.__len__())
